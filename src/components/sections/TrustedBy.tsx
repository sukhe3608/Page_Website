      ...
      <div className="marquee relative overflow-hidden">
        ...
        <Marquee duration={75}>
          {partnerLogos.map((logo) => (
            <span
              key={logo}
              className="mx-2 flex h-10 w-24 shrink-0 items-center justify-center rounded-lg border border-line bg-white px-2 shadow-soft transition-colors duration-300 hover:border-primary/25"
            >
              <img
