  ...
  return (
    <PageTransition>
      <Seo
        ...
        description="The terms that govern your use of Shiva Engineers' website, products and services."
        path="/terms"
      ...
      <LegalLayout
        intro="These Terms of Service (the &ldquo;Terms&rdquo;) govern your access to and use of the Shiva Engineers website, products and services. By using them, you agree to these Terms. If you don't agree, please don't use them."
        ...
        sections={[
          ...
          },
          {
            id: "governing-law",
            title: "Governing law",
            body: <p>These Terms are governed by the laws of India, and any disputes are subject to the exclusive jurisdiction of the courts of New Delhi, Delhi.</p>,
          },
          {
            id: "contact",
            title: "Contact",
